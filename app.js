...
async function fetchData() {
  try {
    ...
    const response = await fetch('https://web-production-ec8f7.up.railway.app/getMarker');
...
async function refresh() {
    try {
        const response = await fetch('https://web-production-ec8f7.up.railway.app/newUser')
...
async function add_alarm() {
  try {
    ...
    const response = await fetch('https://web-production-ec8f7.up.railway.app/setAlarm', {
      method: 'POST',
      headers: {
...
async function sync_user_list() {
  const response = await fetch('https://web-production-ec8f7.up.railway.app/getUsers')
...
document.getElementById("alarm_list").addEventListener('click', async function(event) {
  if (event.target.classList.contains('cancel-btn')) {
    ...
    const response = await fetch('https://web-production-ec8f7.up.railway.app/deleteAlarm', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
